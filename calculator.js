...
app
  .route("/")
  .get(function(req, res) { //get request is ment to get files from the server
  ...
  .post(function(req, res) { //http post request is when the browser posts/gives data to the server that the user has entered.
